...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference("Serie.count") do
      post series_url, params: { series: { Data_De_Lancamento: @series.Data_De_Lancamento, description: @series.description, diretor: @series.diretor, episodios: @series.episodios, nome: @series.nome } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { Data_De_Lancamento: @series.Data_De_Lancamento, description: @series.description, diretor: @series.diretor, episodios: @series.episodios, nome: @series.nome } }
