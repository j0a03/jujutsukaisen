...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference("Anime.count") do
      post animes_url, params: { anime: { atual: @anime.atual, episodios: @anime.episodios, nome: @anime.nome, nota: @anime.nota } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { atual: @anime.atual, episodios: @anime.episodios, nome: @anime.nome, nota: @anime.nota } }
